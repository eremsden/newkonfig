...
(function () {
  ...
  var attachments = [
    { id: "thread-16-1-b", name: "Без наконечника", dist: 0, series: ["16-1"], kind: "thread" },
    { id: "thread-16-2-b", name: "Без наконечника", dist: 0, series: ["16-2"], kind: "thread" },
    { id: "thread-16-4-b", name: "Без наконечника", dist: 0, series: ["16-4"], kind: "thread" },
    { id: "thread-16-6-b", name: "Без наконечника", dist: 0, series: ["16-6"], kind: "thread" },
    { id: "thread-16-1-a", name: "Без наконечника", dist: 0, series: ["16-1"], kind: "thread" },
    { id: "thread-16-2-a", name: "Без наконечника", dist: 0, series: ["16-2"], kind: "thread" },
    { id: "thread-16-4-a", name: "Без наконечника", dist: 0, series: ["16-4"], kind: "thread" },
    { id: "thread-16-6-a", name: "Без наконечника", dist: 0, series: ["16-6"], kind: "thread" },
    { id: "A246-B246", name: "Шарнир Пластик M8", dist: 19, series: ["16-1", "16-2"], kind: "ball" },
    { id: "A201-B201", name: "Шарнир Сталь M8", dist: 19, series: ["16-1", "16-2"], kind: "ball" },
    { id: "A207-B207", name: "Шарнир Сталь M8", dist: 19, series: ["16-4", "16-6"], kind: "ball" },
    { id: "A129-B129", name: "Шарнир Хром M8", dist: 30, series: ["16-4", "16-6"], kind: "ball" },
    { id: "A199-B199", name: "Шарнир Хром M10", dist: 30, series: ["16-4", "16-6"], kind: "ball" },
    { id: "A30-B30", name: "Проушина цинк Ø8.1", dist: 16, series: ["16-4", "16-6"], kind: "eye" },
    { id: "A31-B31", name: "Проушина цинк Ø10.1", dist: 16, series: ["16-4", "16-6"], kind: "eye" },
    { id: "A104-B104", name: "Проушина цинк Ø12", dist: 16, series: ["16-1", "16-2"], kind: "eye" },
    { id: "A220-B220", name: "Проушина цинк Ø6.1", dist: 16, series: ["16-1", "16-2"], kind: "eye" },
    { id: "A221-B221", name: "Проушина цинк Ø8.1", dist: 16, series: ["16-1", "16-2"], kind: "eye" },
    { id: "A222-B222", name: "Проушина цинк Ø10.1", dist: 16, series: ["16-1", "16-2"], kind: "eye" },
    { id: "A26-B26", name: "Проушина цинк Ø12", dist: 16, series: ["16-4", "16-6"], kind: "eye" },
    { id: "A1-B1", name: "Проушина цинк Ø6.1 (28)", dist: 28, series: ["16-1", "16-2"], kind: "eye" },
    { id: "A2-B2", name: "Проушина цинк Ø8.1 (28)", dist: 28, series: ["16-1", "16-2"], kind: "eye" },
    { id: "A13-B13", name: "Проушина цинк Ø8.1 (28)", dist: 28, series: ["16-4", "16-6"], kind: "eye" },
    { id: "A20-B20", name: "Проушина цинк Ø10.1 (22)", dist: 22, series: ["16-4", "16-6"], kind: "eye" },
    { id: "A10-B10", name: "Проушина цинк Ø8.1 (13)", dist: 13, series: ["16-1", "16-2"], kind: "eye" },
    { id: "A223-B223", name: "Проушина цинк Ø6.1 (13)", dist: 13, series: ["16-1", "16-2"], kind: "eye" },
    { id: "A111-B111", name: "Проушина цинк Ø8.1 (22)", dist: 22, series: ["16-4", "16-6"], kind: "eye" },
    { id: "A232-B232", name: "Вильчатая головка M6", dist: 24, series: ["16-1", "16-2"], kind: "clevis" },
    { id: "A412-B412", name: "Проушина пластик", dist: 16, series: ["16-4", "16-6"], kind: "eye" },
    { id: "A21-B21", name: "Вильчатая головка M8", dist: 32, series: ["16-4", "16-6"], kind: "clevis" },
  ];
  ...
  /* ---------- SVG НАКОНЕЧНИКОВ И ПРУЖИНЫ ---------- */
  function fittingSvg(kind, label) {
    var body = "";
    if (kind === "ball") {
      body =
        '<circle cx="70" cy="45" r="14" fill="none" stroke="#29abe2" stroke-width="3"/>' +
        '<circle cx="70" cy="45" r="5" fill="#1b2a3a"/>' +
        '<rect x="84" y="40" width="36" height="10" rx="2" fill="#1b2a3a"/>';
    } else if (kind === "eye") {
      body =
        '<rect x="40" y="28" width="36" height="34" rx="4" fill="none" stroke="#1b2a3a" stroke-width="3"/>' +
        '<circle cx="58" cy="45" r="8" fill="none" stroke="#29abe2" stroke-width="3"/>' +
        '<rect x="76" y="40" width="36" height="10" rx="2" fill="#1b2a3a"/>';
    } else if (kind === "clevis") {
      body =
        '<path d="M40 28 h24 v10 h-10 v14 h10 v10 h-24 z" fill="none" stroke="#1b2a3a" stroke-width="3"/>' +
        '<circle cx="58" cy="45" r="5" fill="#29abe2"/>' +
        '<rect x="64" y="40" width="40" height="10" rx="2" fill="#1b2a3a"/>';
    } else if (kind === "weld") {
      body =
        '<circle cx="58" cy="45" r="14" fill="none" stroke="#1b2a3a" stroke-width="3"/>' +
        '<circle cx="58" cy="45" r="7" fill="none" stroke="#29abe2" stroke-width="2"/>' +
        '<rect x="72" y="40" width="36" height="10" rx="2" fill="#1b2a3a"/>';
    } else {
      body =
        '<rect x="48" y="38" width="52" height="14" rx="2" fill="#1b2a3a"/>' +
        '<path d="M100 38 v14" stroke="#29abe2" stroke-width="2"/>' +
        '<path d="M108 38 v14" stroke="#29abe2" stroke-width="2"/>' +
        '<path d="M116 38 v14" stroke="#29abe2" stroke-width="2"/>';
    }
    return (
      '<svg viewBox="0 0 160 90" xmlns="http://www.w3.org/2000/svg">' +
      '<rect width="160" height="90" fill="#fff"/>' +
      body +
      '<text x="80" y="82" text-anchor="middle" font-size="9" fill="#5b6b7c" font-family="sans-serif">' +
      (label || "") +
      "</text></svg>"
    );
  }
  ...
  function drawSpring() {
    ...
    var tubeH = Math.min(36, 10 + lim.tube * 0.7);
    var rodH = Math.max(6, lim.rod);
    var y = 80;
    var svg =
      '<svg viewBox="0 0 420 160" class="spring-drawing" xmlns="http://www.w3.org/2000/svg">' +
      '<text x="210" y="24" text-anchor="middle" font-size="12" font-weight="700" fill="#1b2a3a" font-family="sans-serif">Серия ' +
      series +
      " · " +
      (conn === "threaded" ? "резьбовое" : "сварное") +
      "</text>" +
      '<text x="46" y="58" text-anchor="middle" font-size="10" fill="#29abe2" font-family="sans-serif">B шток</text>' +
      '<text x="374" y="58" text-anchor="middle" font-size="10" fill="#29abe2" font-family="sans-serif">A трубка</text>' +
      '<rect x="40" y="' +
      (y - rodH / 2) +
      '" width="150" height="' +
      rodH +
      ...
      '<circle cx="28" cy="' +
      y +
      '" r="10" fill="none" stroke="#29abe2" stroke-width="3"/>' +
      '<circle cx="392" cy="' +
      y +
      '" r="10" fill="none" stroke="#29abe2" stroke-width="3"/>' +
      '<text x="210" y="140" text-anchor="middle" font-size="11" fill="#5b6b7c" font-family="sans-serif">Ø штока ' +
      lim.rod +
      " мм · Ø трубки " +
      lim.tube +
      " мм · " +
      lim.thread +
      "</text></svg>";
    $("spring-draw").innerHTML = svg;
  }

  function setTipSvg(elId, kind, label) {
    var el = $(elId);
    if (el) el.innerHTML = fittingSvg(kind, label);
  }

  /* ---------- КОНФИГУРАТОР: ваш код ---------- */
  function updateUI() {
    if (!$("series")) return;
    var series = $("series").value;
  ...
  function isTipSelected(side) {
    ...
    var val = $(selectId).value.split("|")[0];
  ...
  function updateTipImages() {
    ...
    if (conn === "threaded") {
      var valA = ($("attach-a").value || "").split("|")[0];
      var valB = ($("attach-b").value || "").split("|")[0];
      var tipA = attachments.find(function (a) {
        return a.id === valA;
      });
      var tipB = attachments.find(function (a) {
        return a.id === valB;
      });
      setTipSvg("img-a", tipA ? tipA.kind : "none", tipA ? tipA.name : "Не выбран");
      setTipSvg("img-b", tipB ? tipB.kind : "none", tipB ? tipB.name : "Не выбран");
      ...
      setTipSvg("img-a", "weld", "Сварная проушина");
      setTipSvg("img-b", "weld", "Сварная проушина");
  ...
  function openDetail(side) {
    ...
    var selectId = side === "a" ? "attach-a" : "attach-b";
    var val = $(selectId).value.split("|")[0];
    var tip = attachments.find(function (a) {
      return a.id === val;
    });
    if (tip && tip.id !== "none") {
      $("modal-title").innerText = tip.name;
      $("modal-img-slot").innerHTML = fittingSvg(tip.kind, tip.name + " · +" + tip.dist + " мм");
      $("modal-img").style.display = "none";
      $("modal-img-slot").style.display = "block";
  ...
  function openMainDrawing() {
    ...
    $("modal-img").style.display = "none";
    $("modal-img-slot").style.display = "block";
    $("modal-img-slot").innerHTML = $("spring-draw").innerHTML;
    $("detailModal").classList.add("open");
    $("detailModal").style.display = "flex";
  }
  ...
  function openImage(src, title) {
    ...
    $("modal-img-slot").style.display = "none";
    $("detailModal").classList.add("open");
    $("detailModal").style.display = "flex";
  }
  ...
  async function downloadPDF() {
    ...
    $("pdf-img-rod").src =
      "data:image/svg+xml;utf8," + encodeURIComponent($("img-a").innerHTML);
    $("pdf-img-tube").src =
      "data:image/svg+xml;utf8," + encodeURIComponent($("img-b").innerHTML);
    var springSvg = $("spring-draw").querySelector("svg");
    $("pdf-main-img").src = springSvg
      ? "data:image/svg+xml;utf8," + encodeURIComponent(springSvg.outerHTML)
      : "";
